        ...
        <div className="w-full flex flex-col xl:flex-row xl:items-center xl:justify-between gap-10">
          <div className="text-left max-w-2xl">
            ...
            <p className="text-base sm:text-lg text-white/85 max-w-xs leading-relaxed mt-24">
              Evidence-informed, integrated health optimization programs combining nutrition, fitness, metabolic health, and nervous system regulation to help you build resilience and thrive at every stage of life.
            </p>
          </div>
